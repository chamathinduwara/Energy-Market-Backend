...
public class APIResponse <T>{
    ...
    public static <T> APIResponse<T> success(){return new APIResponse<>("SUCCESS", null, true);}

    public static <T> APIResponse<T> success(T data){return new APIResponse<>("SUCCESS", data, true);}
