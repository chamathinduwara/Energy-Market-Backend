...
//    }
//
//    public UniqueIdentifier nodeACreatesProposal(Boolean isBuyer, Double amount,Double unitPrice, Double rate, Party counterparty) throws ExecutionException, InterruptedException {
//        ProposalFlow.Initiator flow = new ProposalFlow.Initiator(isBuyer, amount,unitPrice, rate, counterparty);
...
//    }
//
//    public void nodeBModifiesProposal(UniqueIdentifier proposalId, Double newAmount, Double newUnitPrice, Double newRate) throws ExecutionException, InterruptedException {
