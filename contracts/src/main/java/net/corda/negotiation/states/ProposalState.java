...
public class ProposalState implements LinearState {
    ...
    public ProposalState(Double amount,Double unitPrice, Party buyer, Party seller, Party proposer, Party proposee, UniqueIdentifier linearId) {
        this.amount = amount;
    ...
    public ProposalState(Double amount,Double unitPrice, Party buyer, Party seller, Party proposer, Party proposee) {
        this.amount = amount;
        this.unitPrice = unitPrice;
        this.buyer = buyer;
        this.seller = seller;
